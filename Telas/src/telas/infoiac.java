...
public class infoiac extends JFrame {
	...
	public infoiac() {
		...
		lblNewLabel.setIcon(new ImageIcon(infoiac.class.getResource("/imagens/iac3.jpg")));
		...
		JLabel lblNewLabel_2_1_2 = new JLabel("Para obter o resultado pela fórmula ((quadril/(altura^1.5))-18;) é necessário ter as medidas da ");
		lblNewLabel_2_1_2.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		lblNewLabel_2_1_2.setBounds(44, 390, 710, 41);
		contentPane.add(lblNewLabel_2_1_2);
		
		JLabel lblNewLabel_2_1_3 = new JLabel("altura e circuferência do quadril.O formato que deve ser usado na altura é em metros,");
		lblNewLabel_2_1_3.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		lblNewLabel_2_1_3.setBounds(44, 418, 667, 41);
		contentPane.add(lblNewLabel_2_1_3);
		
		JLabel lblNewLabel_2_1_3_1 = new JLabel("utilizando o ponto (.). Exemplo: 1.75. O formato que deve ser usado no quadril é em ");
		lblNewLabel_2_1_3_1.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		lblNewLabel_2_1_3_1.setBounds(44, 444, 667, 41);
		contentPane.add(lblNewLabel_2_1_3_1);
		
		JLabel lblNewLabel_2_1_3_2 = new JLabel("centímetros. Exemplo: 120");
		lblNewLabel_2_1_3_2.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		lblNewLabel_2_1_3_2.setBounds(44, 468, 667, 41);
