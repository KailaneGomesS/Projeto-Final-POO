...
public class infoimc extends JFrame {
	...
	public infoimc() {
		...
		lblNewLabel.setIcon(new ImageIcon(infoimc.class.getResource("/imagens/imc3.jpg")));
		lblNewLabel.setBounds(10, 151, 796, 252);
		contentPane_1.add(lblNewLabel);
		
		JLabel lblNewLabel_2 = new JLabel("Informações sobre IMC");
		lblNewLabel_2.setFont(new Font("Times New Roman", Font.BOLD, 22));
		lblNewLabel_2.setBounds(277, 38, 243, 26);
		contentPane_1.add(lblNewLabel_2);
		
		JLabel lblNewLabel_2_1 = new JLabel("IMC, o Índice de Massa Corporal, tem como resultado a quantidade de");
		...
		JLabel lblNewLabel_2_1_1 = new JLabel("massa presente no corpo, calculando se esse valor é ideal ou não.\r\n");
		...
		JLabel lblNewLabel_2_1_2 = new JLabel("Para obter o resultado pela fórmula (peso/(altura²) é necessário ter as medidas da altura e peso.");
